...
public class FerramentaController {
    ...
    @PostMapping("/ferramentas/editar")
    public String editarFerramentas(Model model, FerramentaDTO ferramenta){
        service.editarFerramenta(ferramenta);
        model.addAttribute(editarFerramentas);
        return null;
    }
